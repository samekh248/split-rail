...
public class ExceptionHandlerMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        var (statusCode, type, detail, errors) = exception switch
        {
            ...
            BlockConflictException blockConflict => (HttpStatusCode.Conflict, "block_conflict", blockConflict.Message, null),
            AllocationConflictException allocationConflict => (HttpStatusCode.Conflict, "allocation_conflict", allocationConflict.Message, null),
            FestivalDateConflictException dateConflict => (HttpStatusCode.Conflict, "festival_date_conflict", dateConflict.Message, null),
